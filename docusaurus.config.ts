    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: '変革手段',
          items: [
            { label: '知見・意思決定の変革', to: '/docs/知見・意思決定の変革/概要' },
            { label: '人・能力の変革', to: '/docs/人・能力の変革/概要' },
            { label: '体制・人材の変革', to: '/docs/体制・人材の変革/概要' },
            { label: '実行・プロセスの変革', to: '/docs/実行・プロセスの変革/概要' },
            { label: '販路・外部資本の変革', to: '/docs/販路・外部資本の変革/概要' },
          ],
        },
      ],
