...
const TOOLS: Record<string, Tool> = {
  ...
  consulting: { name: 'コンサルティングファーム活用',          path: '/docs/変革マップ/知見・意思決定の変革/コンサルティングファーム活用' },
  ...
  freelance:  { name: '外部人材活用',                         path: '/docs/変革マップ/体制・人材の変革/外部人材活用' },
  ...
  bpo:        { name: 'BPO・RPO導入',                         path: '/docs/変革マップ/実行・プロセスの変革/BPO・RPO導入' },
  ...
  eigyo:      { name: '営業プロセス改革',                     path: '/docs/変革マップ/売上・収益の変革/営業プロセス改革' },
  marketing:  { name: 'マーケティング変革',                   path: '/docs/変革マップ/売上・収益の変革/マーケティング変革' },
  cs:         { name: 'カスタマーサクセス',                   path: '/docs/変革マップ/売上・収益の変革/カスタマーサクセス' },
  revops:     { name: 'RevOps導入',                           path: '/docs/変革マップ/売上・収益の変革/RevOps導入' },
...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    symptoms: [
      ...
      { id: 'C-6', label: 'やるべきことは分かっているが、日常業務で手一杯で変革に着手できない', toolIds: ['bpr', 'bpo', 'tool', 'pmo', 'freelance'] },
      { id: 'C-7', label: '特定の人だけが常に忙しく、キーパーソンが倒れたら業務が止まるリスクがある', toolIds: ['bpr', 'bpo', 'training', 'freelance', 'tool'] },
    ],
  },
  {
    id: 'D',
  ...
  },
  {
    ...
    color: '#e63946',
    symptoms: [
      { id: 'H-1', label: '特定の営業担当の成績だけが突出し、チームが底上げされない。なぜ受注・失注したか分からない', toolIds: ['eigyo', 'revops', 'tool'] },
      { id: 'H-2', label: '新規顧客が紹介・社長人脈頼み。Webサイトはあるが問い合わせが来ない', toolIds: ['marketing', 'revops', 'research'] },
      { id: 'H-3', label: '新規受注はあるが解約・離脱で相殺されている。既存顧客からのアップセルが起きない', toolIds: ['cs', 'revops'] },
      { id: 'H-4', label: '「リードの質が悪い」「営業が追わない」と部門間で責任のなすりつけがある。売上が伸びない理由を数字で説明できない', toolIds: ['revops', 'data', 'eigyo', 'marketing'] },
      { id: 'H-5', label: '競合との差別化が薄く価格で比較される。値引き要求に応じないと失注してしまう', toolIds: ['marketing', 'cs', 'research'] },
    ],
  },
];
